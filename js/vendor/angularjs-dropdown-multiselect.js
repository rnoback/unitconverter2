    ...
    function ($filter, $document, $compile, $parse) {
        ...
        return {
            ...
            template: function (element, attrs) {
                ...
                template += '<button type="button" class="dropdown-toggle" ng-class="settings.buttonClasses" ng-click="toggleDropdown()">{{getButtonText()}}&nbsp;<span class="fa fa-chevron-down" ></span></button>';
                ...
                if (checkboxes) {
                    ...
                    template += '<span data-ng-class="{\'fa fa-check-circle\': isChecked(getPropertyForObject(option,settings.idProp))}"></span> {{getPropertyForObject(option, settings.displayProp)}}</a>';
                }
